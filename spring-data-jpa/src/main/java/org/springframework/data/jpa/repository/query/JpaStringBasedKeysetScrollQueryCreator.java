 ...
 * @since 3.1
 */
class JpaStringBasedKeysetScrollQueryCreator extends JpaStringBasedQueryCreator {

	private final JpaEntityInformation<?, ?> entityInformation;
	private final KeysetScrollPosition scrollPosition;

	public JpaStringBasedKeysetScrollQueryCreator(PartTree tree, Iterable<? extends Parameter> parameterProvider,
			ReturnedType returnedType, JpaEntityInformation<?, ?> entityInformation, KeysetScrollPosition scrollPosition) {
		super(tree, parameterProvider, returnedType);
